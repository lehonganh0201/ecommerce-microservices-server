...
public class PaymentServiceImpl implements PaymentService {
    ...
    public GlobalResponse<com.microservice.ecommerce.model.dto.response.PaymentResponse> saveMoMoPayment(PaymentRequest request) throws Exception {
        ...
        String returnURL = "http://localhost:5173/payments";
        String notifyURL = "http://localhost:5173/payments";
...
//      Remember to change the IDs at enviroment.properties file
    ...
    @Override
    public GlobalResponse<com.microservice.ecommerce.model.dto.response.PaymentResponse> saveVNPayPayment(
        ...
        try {
            ...
            com.microservice.ecommerce.model.dto.response.PaymentResponse paymentResponse =
                    savePayment(request, UUID.randomUUID());
            paymentResponse.setPaymentUrl(paymentUrl);

            return new GlobalResponse<>(Status.SUCCESS, paymentResponse);
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return new GlobalResponse<>(Status.ERROR, null);
        }
    }
